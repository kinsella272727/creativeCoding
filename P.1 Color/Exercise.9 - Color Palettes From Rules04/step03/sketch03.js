...
function draw() {
  ...
  for (var i = rowCount; i >= 0; i--) {
    ...
    for (var ii = 0; ii < parts.length; ii++) {
      ...
      //if the value between 0 and 1 is less than 0.45 then the rectangles will be created
      if (random() < 0.45) {
...
//Function for creating the gradients and the rectangles
function gradient(x, y, w, h, c1, c2) {
  var ctx = drawingContext;
  //This creates a linear gradient and stores it in a variable
